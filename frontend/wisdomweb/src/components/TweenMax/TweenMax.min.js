    ...
    function (a, b, c) {
        ...
        (l.render = function (a, b, d) {
          ...
          if (
            (a >= q - h && a >= 0
              ? ((p._totalTime = q),
                ...
                p._reversed ||
                  ((e = !0), (f = 'onComplete'), (d = d || p._timeline.autoRemoveChildren)),
                0 === u &&
                    ...
                    p._yoyo &&
                      ...
                      o &&
                        (p._yoyoEase ||
                          (o !== !0 || p._initted
                            ? (p._yoyoEase = o =
                                o === !0 ? p._ease : o instanceof Ease ? o : Ease.map[o])
                            : ((o = p.vars.ease),
                              (p._yoyoEase = o =
                                o
                                  ? o instanceof Ease
                      ...
                      1 === m
                        ...
                        : 2 === m
                          ...
                          : 3 === m
                            ...
                            : 4 === m && (k *= k * k * k * k),
                      (p.ratio =
                        1 === l ? 1 - k : 2 === l ? k : p._time / u < 0.5 ? k / 2 : 1 - k / 2))
          ...
          if (!p._initted) {
            ...
            if (
              !d &&
              p._firstPT &&
              ((p.vars.lazy !== !1 && p._duration) || (p.vars.lazy && !p._duration))
            )
              return (
                (p._time = r),
                (p._totalTime = s),
        ...
        (g.staggerTo = g.allTo =
          function (a, b, h, i, l, n, o) {
            ...
            for (
              ...
              for (s in h) q[s] = h[s]
              if (
                (v && (e(q, a, r), null != q.duration && ((b = q.duration), delete q.duration)), w)
              ) {
                w = q.startAt = {}
      ...
      var p = function (a, c, d, e) {
        ...
        for (var f, g, h = o(e), i = c && d && e, j = h.length; --j > -1; )
          (g = h[j]),
            (i || g instanceof b || ((f = g.target === g.vars.onComplete) && d) || (c && !f)) &&
              g.paused(a)
      }
      return (
        ...
        return (
          ...
          (s.add = function (e, f, g, h) {
            var j,
              ...
              p = this
            if (
              ('number' != typeof f && (f = p._parseTimeOrLabel(f, 0, !0, e)), !(e instanceof a))
            ) {
      ...
      function (a, b, c) {
        ...
        return (
          ...
          (k.tweenFromTo = function (a, b, c) {
            ...
            return (
              (d.isFromTo = 1), d.duration(Math.abs(d.vars.time - a) / this._timeScale || 0.001)
            )
          }),
      ...
      var a = 180 / Math.PI,
          ...
          for (j = s.length; --j > -1; ) {
            ...
            for (l = n - q + 1, n = 0, k = 0; l > k; k += q)
              (d = i[k]),
                ...
                (h = 2 === q ? 0 : i[k + 3]),
                (i[n++] = o =
                  3 === q ? new g(d, e, f, h) : new g(d, (2 * e + d) / 3, (2 * e + f) / 3, f))
            i.length = n
          }
          return p
        },
        n = function (a, b, c) {
          for (var d, e, f, g, h, i, j, k, l, m, n, o = 1 / c, p = a.length; --p > -1; )
            for (
              m = a[p], f = m.a, g = m.d - f, h = m.c - f, i = m.b - f, d = e = 0, k = 1;
              c >= k;
              k++
            )
              (j = o * k),
      ...
      function (a, b) {
        ...
        var k,
          ...
          $ = function (a, b) {
            ...
            return d >= 0
              ? ((Z = 3 === d ? 'ms' : c[d]), (Y = '-' + Z.toLowerCase() + '-'), Z + a)
              : null
          },
          _ =
          ...
          ca = (T.convertToPixels = function (a, c, d, e, f) {
            ...
            if ((n && (d = -d), o && (d *= 100), 'lineHeight' !== c || e))
              if ('%' === e && -1 !== c.indexOf('border'))
                ...
                if (
                  ((m.cssText =
                    'border:0 solid red;position:' + ba(a, 'position') + ';line-height:0;'),
            ...
            return k
              ? (e = b
                  ...
                  : function (a) {
                      ...
                      return (
                        (h && 'none' !== a ? a.substr(0, a.indexOf(b[0])) || h : h) + b.join(j) + i
                      )
                    })
              : function (a) {
                  return a
                ...
                ? (g.l++,
                  ...
                  h > 0
                    ? ((g.data['xn' + h] = b + c),
                      ...
                      (g['xn' + h] = b),
                      g.plugin ||
                        ((g.xfirst = new va(g, 'xn' + h, b, c, g.xfirst || g, 0, g.n, e, g.pr)),
                        (g.xfirst.xs0 = 0)),
                      g)
                    : ((g.data = {
                        s: b + c,
        ...
        var Ca,
          ...
          Sa = function (a, b) {
            ...
            for (e = (d || '').match(s) || [], ya = e.length; --ya > -1; )
              (f = Number(e[ya])),
                (e[ya] = (g = f - (f |= 0)) ? ((g * k + (0 > g ? -0.5 : 0.5)) | 0) / k + f : f)
            ...
            if (
              ...
              if (16 === f.length) {
                ...
                ;(m.x = f[4] || 0),
                  ...
                  (m.skewX = l),
                  Ha &&
                    ((m.rotationX = m.rotationY = m.z = 0), (m.perspective = r), (m.scaleZ = 1)),
                  m.svg &&
                  ...
                  return void (B || P || K
                    ? ((B *= L),
                      ...
                      x &&
                        ...
                        (g *= b),
                        O &&
                          ((b = Math.tan(O * L)), (b = Math.sqrt(1 + b * b)), (c *= b), (f *= b))),
                      K &&
        ...
        ;(j = Ia.prototype),
            ...
            'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
            {
              parser: function (a, b, c, d, f, h, i) {
                ...
                var k,
                  ...
                  D =
                    z.transform &&
                    ('function' == typeof z.transform ? z.transform(r, q) : z.transform)
                if (
                ...
                return (
                  ...
                  (D || (Ha && m && C.zOrigin)) &&
                    (Ea
                      ...
                      : ja(D + '', C)),
                  n &&
                    (d._transformType = (C.svg && Ca) || (!m && 3 !== this._transformType) ? 2 : 3),
                  j && (i.scale = j),
                  f
                )
              },
          ...
          Aa('backgroundPosition', {
            ...
            parser: function (a, b, c, d, f, g) {
              ...
              if (
                ...
                for (
                  h = q.split(' '), i = r.split(' '), S.setAttribute('src', m), j = 2;
                  --j > -1;
                  ...
                  (q = h[j]),
                    (k = -1 !== q.indexOf('%')),
                    k !== (-1 !== i[j].indexOf('%')) &&
                      ((l = 0 === j ? a.offsetWidth - S.width : a.offsetHeight - S.height),
                      (h[j] = k
          ...
          Aa('backgroundSize', {
            ...
            formatter: function (a) {
              return (
                (a += ''), 'co' === a.substr(0, 2) ? a : ja(-1 === a.indexOf(' ') ? a + ' ' + a : a)
              )
            },
          }),
          Aa('perspective', {
          ...
          if (
            ...
            if ('all' === this.e) (g.cssText = ''), (e = !0)
              ...
              for (b = this.e.split(' ').join('').split(','), d = b.length; --d > -1; )
                (c = b[d]),
                  i[c] &&
                    (i[c].parse === h ? (e = !0) : (c = 'transformOrigin' === c ? Ga : i[c].p)),
                  Xa(g, c)
            e &&
              (Xa(g, Ea),
        ...
        ;(j = g.prototype),
                    ...
                    ? m &&
                      ...
                      o &&
                        this._addLazySet(
                          ...
                          this._vars.WebkitBackfaceVisibility || (y ? 'visible' : 'hidden'),
                        ))
                    : (A.zoom = 1),
                  s = p;
                s && s._next;
            ...
            for (g in b) {
              if (
                ...
                ;(m = ba(a, g, e) + ''),
                  ...
                  (s && B.test(n))
                    ? (s ||
                        ((n = pa(n)), (n = (n.length > 3 ? 'rgba(' : 'rgb(') + n.join(',') + ')')),
                        ...
                        (!j && 0 !== j) || (!l && 0 !== l)
                          ? void 0 !== u[g] && (n || (n + '' != 'NaN' && null != n))
                            ? ((c = new va(u, g, l || j || 0, 0, c, -1, g, !1, 0, m, n)),
                              (c.xs0 =
                                'none' !== n || ('display' !== g && -1 === g.indexOf('Style'))
                                  ? n
                                  : m))
          ...
          (j.setRatio = function (a) {
            ...
            if (1 !== a || (this._tween._time !== this._tween._duration && 0 !== this._tween._time))
              if (
                ...
                for (; e; ) {
                  if (
                    ((b = e.c * a + e.s), e.r ? (b = e.r(b)) : f > b && b > -f && (b = 0), e.type)
                  )
                    if (1 === e.type)
          ...
          (j._enableTransforms = function (a) {
            ;(this._transform = this._transform || Ta(this._target, e, !0)),
              (this._transformType =
                (this._transform.svg && Ca) || (!a && 3 !== this._transformType) ? 2 : 3)
          })
        var $a = function (a) {
  ...
  (function (a, b) {
    ...
    var H = u(
        ...
        function (b, c, d) {
          ...
          if (
            ((this._overwrite = i =
              null == i ? X[H.defaultOverwrite] : 'number' == typeof i ? i >> 0 : X[i]),
